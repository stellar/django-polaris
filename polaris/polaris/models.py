...
class Quote(models.Model):
    ...
    sell_amount = models.DecimalField(null=True, blank=True, max_digits=30, decimal_places=7)
    """
    The amount of sell_asset the client would exchange for buy_asset.
    """

    buy_amount = models.DecimalField(null=True, blank=True, max_digits=30, decimal_places=7)
    """
...
class OffChainAsset(models.Model):
    ...
    country_codes = models.TextField(null=False, blank=True)
