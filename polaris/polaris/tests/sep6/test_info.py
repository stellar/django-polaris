...
def good_info_integration(request, asset, lang, *args, **kwargs):
    """
    From the SEP
    """
    return {
...
def test_good_info_response(client, usd_asset_factory):
    usd_asset_factory(protocols=[Transaction.PROTOCOL.sep6, "sep38"])
...
def bad_fields_type_integration(request, asset, lang, *args, **kwargs):
...
def bad_types_type(request, asset, lang, *args, **kwargs):
...
def bad_nested_fields_no_description(request, asset, lang, *args, **kwargs):
...
def bad_nested_fields_extra_key(request, asset, lang, *args, **kwargs):
    return {
        "types": {
            "cash": {
                "fields": {
