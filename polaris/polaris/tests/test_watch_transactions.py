...
from polaris.management.commands.watch_transactions import Command, TransactionEnvelope
...
@patch(
    "polaris.management.commands.watch_transactions.TransactionEnvelope.from_xdr",
    return_value=Mock(
        transaction=Mock(
            operations=[
                Mock(
