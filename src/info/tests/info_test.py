import json
import pytest
from ..models import Asset, InfoField, WithdrawalType
...
def _create_initial_assets():
    ...
    withdrawal_phone_number_field = InfoField.objects.create(
        name="phone_number", description="your phone number in case there's an issue"
    )
